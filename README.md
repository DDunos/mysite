...
## 기능 설명
1.  게임 시작 클릭 기능: 게임의 시작을 알리는 버튼
1.  로딩 애니메이션 출력 기능: 로딩 중 사용자가 이목을 끌게하는 영상을 출력
1.  쓰레기 드레그하기: 게임 내에서 올바르게 쓰레기를 재활용하도록 하는 게임 내의 기능
1.  다음 단계로 넘어가기: 1단계에서 2단계로 넘어가는 단편적인 기능
1.  나가기: 나가는 기능
1.  카카오톡에서 엄마에게 자랑하기, 아빠에게 자랑하기 기능: 카카오톡이라는 SNS와 연동되는 알림 서비스 기능이며, 이 기능의 의미대로 사용자인 아이가 게임한 결과를 부모님에게 알려주면서 자랑해주는 독보적인 기능
